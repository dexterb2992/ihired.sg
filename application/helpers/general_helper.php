...
if( !function_exists('sendNotification') ){
	function sendNotification($emailObject, $subject, $title, $msg, $email, $user_fullname){
		...
		$htmlMessage .= "<div style='height:94px;color:#b00;background-color: white;border-bottom: 1px solid;'><div style='height:25px;'>.</div><div style='height:30px;text-align:left;color: #b00;font-size:20px;padding-right:20px;font-family: monospace;margin-left: 15px;font-weight: bold;text-shadow: 0px 1px 1px;'><span style='float:left;margin-top:-22px;'><img src='".base_url()."/assets/images/logo.jpg'></span><span style='float:right;font-family: monospace;font-style: italic;padding-top: 22px;text-shadow: black 0px 1px 3px;'>$title</span></div></div> ";
